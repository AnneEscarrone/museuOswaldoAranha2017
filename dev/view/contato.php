        ...
        <header class="container bg-black menu-height section-header transparence-85">
            <div class="content">
                <h1 class="fontzero">
                    ...
                    <img src="../resources/images/home/logo-museu1.png" alt="Museu Oswaldo Aranha logo" class="ds-block fl-left grid-2">                        
                </h1>
                ...
                <div class="content al-center">
                    ...
                    <div style="margin-top: 40px;">
                        ...
                        <div class="grid-6 al-center" style="height: 180px;">
                            <div class="border-red" style="height: 180px; background: #ffffff;">
                                <img class="ds-inline fl-none" style="margin-top: 40px;" src="../resources/images/home/prefeitura2.png" alt="Logotipo prefeitura">
                            </div>
                        </div>
                        <div class="grid-5 al-center" style="height: 180px;">
                            <div class="border-red" style="height: 180px; background: #ffffff;">
